...
<html lang="{{ LANGUAGE_CODE }}">
  <head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="{% static "zinnia_bootstrap/bootstrap/css/bootstrap.css" %}" />-->
  ...
  <body class="{% block theme-class %}default{% endblock theme-class %} {% block color-class %}blue{% endblock color-class %} {% block sidebar-class %}right-sidebar{% endblock sidebar-class %} ">
    <div class="container">
